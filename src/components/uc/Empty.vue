<template>
  <div class="flex flex-col justify-center items-center p-4">
    <svg t="1697371645651" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
      p-id="1022" width="50" height="50">
      <path
        ...
        p-id="1023" fill="rgba(203,213,225,1)"></path>
    </svg>
    <div class="content">
      <slot>
